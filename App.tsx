...
export default class App extends Component<Props, State> {
    ...
    constructor(Prop) {
        super(Prop)
        this.state = {
            appId: '4b4bc02bdb59420fb441cf01b235fd2c',
            channelName: 'plop',
            token: '0064b4bc02bdb59420fb441cf01b235fd2cIADxkJwjMPJuKvmHRNkdX2JZn8S5Pgy+zgQSHW81m00taZBL1rkAAAAAEACHBVD5tOaCYAEAAQC05oJg',
            joinSucceed: false,
            peerIds: [],
        }
